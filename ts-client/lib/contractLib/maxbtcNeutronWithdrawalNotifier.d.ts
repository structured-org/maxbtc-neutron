...
export interface MaxbtcNeutronWithdrawalNotifierSchema {
    responses: Uint128 | Config | OwnershipForString;
    query: AmountArgs;
    execute: UpdateConfigArgs | SubmitAmountArgs | UpdateOwnershipArgs;
    instantiate?: InstantiateMsg;
    [k: string]: unknown;
}
export interface Config {
    /**
     * Address of the CEFFU backend service
     */
    ceffu_backend: Addr;
    /**
...
export interface UpdateConfig {
    ceffu_backend?: string | null;
    factory_contract?: string | null;
    operator?: string | null;
}
export interface SubmitAmountArgs {
    amount: Uint1281;
    batch_id: number;
}
...
export declare class Client {
    ...
    queryAmount: (args: AmountArgs) => Promise<Uint128>;
    queryOwnership: () => Promise<OwnershipForString>;
    updateConfig: (sender: string, args: UpdateConfigArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
    updateConfigMsg: (args: UpdateConfigArgs) => {
        update_config: UpdateConfigArgs;
    };
    submitAmount: (sender: string, args: SubmitAmountArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
    submitAmountMsg: (args: SubmitAmountArgs) => {
        submit_amount: SubmitAmountArgs;
    };
