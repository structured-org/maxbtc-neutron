...
export declare class Client {
    ...
    queryGetState: () => Promise<State>;
    queryOwnership: () => Promise<OwnershipForString>;
    updateConfig: (sender: string, args: UpdateConfigArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
    updateConfigMsg: (args: UpdateConfigArgs) => {
        update_config: UpdateConfigArgs;
    };
    lock: (sender: string, args: LockArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
    lockMsg: (args: LockArgs) => {
        lock: LockArgs;
    };
    unlock: (sender: string, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
    unlockMsg: () => {
        unlock: {};
    };
