...
export interface MaxbtcNeutronCoinfactoryWrapperSchema {
...
export declare class Client {
    ...
    wrap: (sender: string, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
    wrapMsg: () => {
        wrap: {};
    };
    unwrap: (sender: string, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]) => Promise<ExecuteResult>;
    unwrapMsg: () => {
        unwrap: {};
    };
