...
export class Client {
  ...
  queryFinalizedBatches = async (
    args: FinalizedBatchesArgs,
  ): Promise<ArrayOfBatch> => {
    return this.client.queryContractSmart(this.contractAddress, {
      finalized_batches: args,
    });
  };
  queryFinalizedBatch = async (args: FinalizedBatchArgs): Promise<Batch> => {
    return this.client.queryContractSmart(this.contractAddress, {
      finalized_batch: args,
    });
  };
  ...
  deposit = async (
    ...
    return this.client.execute(
      sender,
      this.contractAddress,
      this.depositMsg(args),
      fee || 'auto',
      memo,
      funds,
    );
  };
  depositMsg = (args: DepositArgs): { deposit: DepositArgs } => {
    return { deposit: args };
  };
  withdraw = async (
    sender: string,
  ...
  mintFee = async (
    ...
    return this.client.execute(
      sender,
      this.contractAddress,
      this.mintFeeMsg(args),
      fee || 'auto',
      memo,
      funds,
    );
  };
  mintFeeMsg = (args: MintFeeArgs): { mint_fee: MintFeeArgs } => {
    return { mint_fee: args };
  };
  mintByOwner = async (
    sender: string,
